...
function adaptDjangoUser(user: any): User {
  return {
    ...
    dailyStreams: user.daily_streams !== undefined ? user.daily_streams : (user.dailyStreams !== undefined ? user.dailyStreams : 0),
    dailyStreamLimit: user.daily_stream_limit !== undefined ? user.daily_stream_limit : (user.dailyStreamLimit !== undefined ? user.dailyStreamLimit : 60),
    playlistLimit: user.playlist_limit !== undefined ? user.playlist_limit : (user.playlistLimit !== undefined ? user.playlistLimit : 6),
