...
export const INITIAL_USERS: User[] = [
  { id: 'u1', email: 'user@test.com', name: 'Ali Reza', role: 'LISTENER', tier: 'GOLD', avatar: 'https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?w=150', followersCount: 12, followingCount: 4, dailyStreams: 15, birthDate: '1998-04-12', gender: 'MALE', isMonetized: false, totalEarnings: 0 },
  ...
  { id: 'a2', email: 'pending@test.com', name: 'Novice Singer', role: 'ARTIST', tier: 'BASIC', avatar: 'https://images.unsplash.com/photo-1527980965255-d3b416303d12?w=150', followersCount: 0, followingCount: 0, dailyStreams: 0, status: 'PENDING', portfolioUrl: 'https://soundcloud.com/sample', bio: 'Aspiring pop singer from Tehran.', isMonetized: false, totalEarnings: 0 },
  { id: 'a3', email: 'rejected@test.com', name: 'Low Quality Audio', role: 'ARTIST', tier: 'BASIC', avatar: 'https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?w=150', followersCount: 0, followingCount: 0, dailyStreams: 0, status: 'REJECTED', rejectionReason: 'Audio sample bitrate is below platform minimum requirements (must be at least 320kbps MP3 or WAV).', portfolioUrl: 'https://soundcloud.com/bad-audio', isMonetized: false, totalEarnings: 0 },
  { id: 's1', email: 'support@test.com', name: 'Support Agent', role: 'SUPPORT', tier: 'GOLD', avatar: 'https://images.unsplash.com/photo-1580489944761-15a19d654956?w=150', followersCount: 0, followingCount: 0, dailyStreams: 0, isMonetized: false, totalEarnings: 0 },
  { id: 'admin1', email: 'admin@test.com', name: 'System Admin', role: 'ADMIN', tier: 'GOLD', avatar: 'https://images.unsplash.com/photo-1633332755192-727a05c4013d?w=150', followersCount: 100, followingCount: 100, dailyStreams: 50, isMonetized: false, totalEarnings: 0 }
];
